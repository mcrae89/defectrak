...
import { ReturnType } from '@syncfusion/ej2-data/src/adaptors';
/**
...
export declare class DataUtil {
     ...
     * @param  {string} substr
     */
    static notEndsWith(input: string, substr: string): boolean;
    /**
     ...
     * @param start
     */
    static notStartsWith(input: string, start: string): boolean;
    /**
     ...
     * @param pattern
     */
    static wildCard(input: string, pattern: string): boolean;
    /**
     ...
     * @param pattern
     */
    static like(input: string, pattern: string): boolean;
    /**
