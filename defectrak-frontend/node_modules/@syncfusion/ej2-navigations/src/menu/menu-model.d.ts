import { attributes, NotifyPropertyChanges, INotifyPropertyChanged, Property } from '@syncfusion/ej2-base';import { Browser, Complex, getUniqueID, SanitizeHtmlHelper } from '@syncfusion/ej2-base';import { MenuBase, FieldSettings } from '@syncfusion/ej2-navigations/src/common/menu-base';import { MenuItemModel, FieldSettingsModel } from '@syncfusion/ej2-navigations/src/common/menu-base-model';
import {Orientation} from "@syncfusion/ej2-navigations/src/menu/menu";
import {MenuBaseModel} from "@syncfusion/ej2-navigations/src/common/menu-base-model";
