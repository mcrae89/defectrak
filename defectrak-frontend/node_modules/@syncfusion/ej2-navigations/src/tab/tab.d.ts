...
import { OverflowMode } from '@syncfusion/ej2-navigations/src/toolbar/toolbar';
import { TabModel, TabItemModel, HeaderModel, TabActionSettingsModel, TabAnimationSettingsModel } from '@syncfusion/ej2-navigations/src/tab/tab-model';
