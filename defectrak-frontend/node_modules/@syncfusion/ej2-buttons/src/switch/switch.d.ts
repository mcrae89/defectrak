...
import { SwitchModel } from '@syncfusion/ej2-buttons/src/switch/switch-model';
import { ChangeEventArgs, BeforeChangeEventArgs } from '@syncfusion/ej2-buttons/src/common/common';
/**
