import { EventHandler, Property, createElement } from '@syncfusion/ej2-base';import { TextArea } from '@syncfusion/ej2-inputs/src/textarea/textarea';import { CaretPosition, CaretPositionHelper } from '@syncfusion/ej2-inputs/src/smart-textarea/caret-helper';
import {SuggestionMode} from "@syncfusion/ej2-inputs/src/smart-textarea/smart-textarea";
import {TextAreaModel} from "@syncfusion/ej2-inputs/src/textarea/textarea-model";
