...
import {TooltipPosition,SpeechToTextState,StartListeningEventArgs,StopListeningEventArgs,ErrorEventArgs,TranscriptChangedEventArgs} from "@syncfusion/ej2-inputs/src/speech-to-text/speech-to-text";
