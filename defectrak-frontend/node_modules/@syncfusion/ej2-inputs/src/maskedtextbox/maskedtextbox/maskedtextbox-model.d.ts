import { Component, Event, Property, EmitType, NotifyPropertyChanges, INotifyPropertyChanged, BaseEventArgs } from '@syncfusion/ej2-base';import { isNullOrUndefined, formatUnit, getValue, setValue, addClass, detach } from '@syncfusion/ej2-base';import { removeClass , Browser, closest} from '@syncfusion/ej2-base';import { Input, InputObject, FloatLabelType } from '@syncfusion/ej2-inputs/src/input/input';import { regularExpressions, createMask, applyMask, wireEvents, unwireEvents, unstrippedValue, strippedValue } from '@syncfusion/ej2-inputs/src/maskedtextbox/base';import { setMaskValue, MaskUndo, setElementValue, bindClearEvent } from '@syncfusion/ej2-inputs/src/maskedtextbox/base';
import {MaskChangeEventArgs,MaskFocusEventArgs,MaskBlurEventArgs} from "@syncfusion/ej2-inputs/src/maskedtextbox/maskedtextbox/maskedtextbox";
