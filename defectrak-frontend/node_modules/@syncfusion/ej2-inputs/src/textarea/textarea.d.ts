...
import { FloatLabelType } from '@syncfusion/ej2-inputs/src/input/input';
import { FocusInEventArgs, FocusOutEventArgs, InputEventArgs, ChangedEventArgs } from '@syncfusion/ej2-inputs/src/textbox/textbox';
