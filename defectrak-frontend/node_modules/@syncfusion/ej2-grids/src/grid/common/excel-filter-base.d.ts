import { IFilterArgs, FilterUI } from '@syncfusion/ej2-grids/src/grid/base/interface';
...
import { IXLFilter } from '@syncfusion/ej2-grids/src/grid/common/filter-interface';
/**
 * @hidden
...
export declare class ExcelFilterBase extends CheckBoxFilterBase {
    ...
    private focusNextOrPrevElement;
    private keyUp;
    private keyDown;
    private excelSetFocus;
    private destroyCMenu;
    private hoverHandler;
    private contextKeyDownHandler;
