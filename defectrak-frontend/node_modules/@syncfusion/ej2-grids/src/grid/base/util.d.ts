import { IPosition, IGrid, IRow, IExpandedRow, PdfExportProperties, ExcelExportProperties, RowDropEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
...
import { ColumnModel, AggregateColumnModel } from '@syncfusion/ej2-grids/src/grid/models/models';
import { AggregateType, HierarchyGridPrintMode } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { Dialog, Popup } from '@syncfusion/ej2-popups';
import { PredicateModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { FilterStateObj, IXLFilter } from '@syncfusion/ej2-grids/src/grid/common/filter-interface';
/**
 ...
 * @hidden
 */
export declare function getRowHeight(element?: HTMLElement, accurateHeight?: boolean): number;
/**
