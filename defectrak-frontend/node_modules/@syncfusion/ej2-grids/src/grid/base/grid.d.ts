...
import { GridModel, ResizeSettingsModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { ReturnType, BatchChanges } from '@syncfusion/ej2-grids/src/grid/base/type';
import { IDialogUI, ScrollPositionType, ActionArgs, ExportGroupCaptionEventArgs, FilterUI, LazyLoadArgs, ContextMenuClickEventArgs, NotifyArgs, ExportHeaders, DetailTemplateDetachArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { AggregateQueryCellInfoEventArgs, IGrid } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { IRenderer, IValueFormatter, IFilterOperator, IIndex, RowDataBoundEventArgs, QueryCellInfoEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { CellDeselectEventArgs, CellSelectEventArgs, CellSelectingEventArgs, ParentDetails, ContextMenuItemModel } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { PdfQueryCellInfoEventArgs, ExcelQueryCellInfoEventArgs, ExcelExportProperties, PdfExportProperties } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { PdfHeaderQueryCellInfoEventArgs, ExcelHeaderQueryCellInfoEventArgs, ExportDetailDataBoundEventArgs, ExportDetailTemplateEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { ColumnMenuOpenEventArgs, BatchCancelArgs, RecordDoubleClickEventArgs, DataResult } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { HeaderCellInfoEventArgs, KeyboardEventArgs, RecordClickEventArgs, AdaptiveDialogEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { FailureEventArgs, FilterEventArgs, ColumnDragEventArgs, GroupEventArgs, PrintEventArgs, ICustomOptr, ReorderEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { RowDeselectEventArgs, RowSelectEventArgs, RowSelectingEventArgs, RowDeselectingEventArgs, PageEventArgs, RowDragEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { BeforeBatchAddArgs, BeforeBatchDeleteArgs, BeforeBatchSaveArgs, ResizeArgs, ColumnMenuItemModel } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { BatchAddArgs, BatchDeleteArgs, BeginEditArgs, CellEditArgs, CellSaveArgs, BeforeDataBoundArgs, RowInfo } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { DetailDataBoundEventArgs, ColumnChooserEventArgs, AddEventArgs, SaveEventArgs, EditEventArgs, DeleteEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { ExcelExportCompleteArgs, PdfExportCompleteArgs, DataStateChangeEventArgs, DataSourceChangedEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { SearchEventArgs, SortEventArgs, ISelectedCell, BeforeCopyEventArgs, ColumnDataStateChangeEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { BeforePasteEventArgs, CheckBoxChangeEventArgs, CommandClickEventArgs, BeforeAutoFillEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { Render } from '@syncfusion/ej2-grids/src/grid/renderer/render';
import { Column, ColumnModel, ActionEventArgs } from '@syncfusion/ej2-grids/src/grid/models/column';
import { SelectionType, GridLine, SortDirection, SelectionMode, PrintMode, FilterType, FilterBarMode } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { CheckboxSelectionType, HierarchyGridPrintMode, NewRowPosition, ClipMode, freezeMode, IndicatorType } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { WrapMode, ToolbarItems, ContextMenuItem, ColumnMenuItem, ToolbarItem, CellSelectionMode, EditMode, ResizeMode } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { ColumnQueryModeType, RowRenderingDirection, AdaptiveMode } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { Data } from '@syncfusion/ej2-grids/src/grid/actions/data';
import { ServiceLocator } from '@syncfusion/ej2-grids/src/grid/services/service-locator';
import { ColumnWidthService } from '@syncfusion/ej2-grids/src/grid/services/width-controller';
import { AriaService } from '@syncfusion/ej2-grids/src/grid/services/aria-service';
import { FocusStrategy } from '@syncfusion/ej2-grids/src/grid/services/focus-strategy';
import { SortSettingsModel, SelectionSettingsModel, FilterSettingsModel, SearchSettingsModel, EditSettingsModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { SortDescriptorModel, PredicateModel, RowDropSettingsModel, GroupSettingsModel, TextWrapSettingsModel, LoadingIndicatorModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { InfiniteScrollSettingsModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { PageSettingsModel, AggregateRowModel, AggregateColumnModel, ColumnChooserSettingsModel } from '@syncfusion/ej2-grids/src/grid/models/models';
import { Sort } from '@syncfusion/ej2-grids/src/grid/actions/sort';
...
import { ShowHide } from '@syncfusion/ej2-grids/src/grid/actions/show-hide';
...
import { Row } from '@syncfusion/ej2-grids/src/grid/models/row';
...
import { CheckState } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { Aggregate } from '@syncfusion/ej2-grids/src/grid/actions/aggregate';
import { ColumnDeselectEventArgs, ColumnSelectEventArgs, ColumnSelectingEventArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
...
export declare class Grid extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     */
    getRowHeight(accurateHeight?: boolean): number;
    /**
