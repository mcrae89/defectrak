...
import { Column, ColumnModel } from '@syncfusion/ej2-grids/src/grid/models/column';
import { SortSettingsModel, TextWrapSettingsModel, SelectionSettingsModel, FilterSettingsModel, SearchSettingsModel, InfiniteScrollSettingsModel, ResizeSettingsModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { PageSettingsModel, AggregateRowModel, ColumnChooserSettingsModel } from '@syncfusion/ej2-grids/src/grid/models/models';
import { RowDropSettingsModel, GroupSettingsModel, GridModel, EditSettingsModel, LoadingIndicatorModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { Cell } from '@syncfusion/ej2-grids/src/grid/models/cell';
import { Row } from '@syncfusion/ej2-grids/src/grid/models/row';
import { GridLine, Action, CellType, SortDirection, PrintMode, ToolbarItems, CommandButtonType, ContextMenuItem, ExcelBorderLineStyle, FocusType } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { MultipleExportType, MultiplePdfExportType, ExportType, ExcelHAlign, ExcelVAlign, BorderLineStyle, ToolbarItem, AggregateTemplateType } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { PredicateModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { SentinelType, Offsets } from '@syncfusion/ej2-grids/src/grid/base/type';
import { CheckState, ColumnQueryModeType, HierarchyGridPrintMode, ClipMode, freezeMode } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { ResponsiveDialogAction, RowRenderingDirection } from '@syncfusion/ej2-grids/src/grid/base/enum';
...
import { Matrix, FocusStrategy } from '@syncfusion/ej2-grids/src/grid/services/focus-strategy';
import { CheckBoxFilterBase } from '@syncfusion/ej2-grids/src/grid/common/checkbox-filter-base';
import { PdfPageSize, PageOrientation, ContentType, PdfPageNumberType, PdfDashStyle, PdfHAlign, PdfVAlign } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { FlMenuOptrUI } from '@syncfusion/ej2-grids/src/grid/renderer/filter-menu-operator';
...
import { FilterMenuRenderer } from '@syncfusion/ej2-grids/src/grid/renderer/filter-menu-renderer';
import { ColumnChooser, Search } from '@syncfusion/ej2-grids/src';
/**
...
export interface IEditCell {
    ...
    params?: DatePickerModel | NumericTextBoxModel | DropDownListModel | CheckBoxModel | MultiSelectModel | AutoCompleteModel | ComboBoxModel | SwitchModel | TimePickerModel | MaskedTextBoxModel | TextBoxModel | DateTimePickerModel;
...
export interface IFilterArgs {
    ...
    parentFilteredLocalRecords?: Object[];
    parentTotalDataCount?: number;
    parentCurrentViewDataCount?: number;
...
export declare type DetailTemplateDetachArgs = DetailTemplateDetach[];
