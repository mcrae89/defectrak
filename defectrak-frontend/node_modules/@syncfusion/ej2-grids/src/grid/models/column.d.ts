...
import { ICellFormatter, IFilterUI, IEditCell, CommandModel, IFilter, CommandButtonOptions, DataResult, IGrid } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { TextAlign, ClipMode, Action, SortDirection, CommandButtonType, freezeDirection, freezeTable, EditType } from '@syncfusion/ej2-grids/src/grid/base/enum';
import { PredicateModel } from '@syncfusion/ej2-grids/src/grid/base/grid-model';
import { ValueAccessor, SortComparer, HeaderValueAccessor } from '@syncfusion/ej2-grids/src/grid/base/type';
/**
