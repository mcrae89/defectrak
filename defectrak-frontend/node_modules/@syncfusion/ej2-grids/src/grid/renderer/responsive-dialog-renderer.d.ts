import { IAction, IGrid, ResponsiveDialogArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
...
import { ResponsiveDialogAction } from '@syncfusion/ej2-grids/src/grid/base/enum';
/**
 *
