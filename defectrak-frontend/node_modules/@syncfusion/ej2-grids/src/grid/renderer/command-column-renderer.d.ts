...
import { IGrid, ICellRenderer } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { CellRenderer } from '@syncfusion/ej2-grids/src/grid/renderer/cell-renderer';
/**
