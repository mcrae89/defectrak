import { IRenderer, IGrid, NotifyArgs, IModelGenerator } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { VirtualInfo } from '@syncfusion/ej2-grids/src/grid/base/interface';
