import { FilterSettings } from '@syncfusion/ej2-grids/src/grid/base/grid';
import { IGrid, IAction, NotifyArgs, IFilterOperator, FilterUI, CustomOperators } from '@syncfusion/ej2-grids/src/grid/base/interface';
...
import { ResponsiveDialogRenderer } from '@syncfusion/ej2-grids/src/grid/renderer/responsive-dialog-renderer';
...
export declare class Filter implements IAction {
     ...
     */
    updateModel(): void;
    private handleExistingFilterCleanup;
