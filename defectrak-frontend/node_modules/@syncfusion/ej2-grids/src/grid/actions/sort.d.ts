import { SortSettings } from '@syncfusion/ej2-grids/src/grid/base/grid';
import { IGrid, IAction, NotifyArgs } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { SortDirection } from '@syncfusion/ej2-grids/src/grid/base/enum';
...
export declare class Sort implements IAction {
    ...
    private excelFilterSortActionHandler;
    private keyPressed;
