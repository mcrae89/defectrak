import { IGrid, IAction, IIndex, ISelectedCell } from '@syncfusion/ej2-grids/src/grid/base/interface';
import { SelectionSettings } from '@syncfusion/ej2-grids/src/grid/base/grid';
