...
.e-grid-popup .e-input-group .e-clear-icon::before {
  content: "\e7a7";
}
...
.e-grid-popup .e-checkboxlist.e-checkbox-infinitescroll {
  ...
  border-top-color: rgba(230, 230, 230, 0.12);
...
.e-grid.sf-grid .e-filterbarcell.e-frozen-right-border {
  border-right: 2px solid rgba(49, 122, 185, 0.6);
}
...
.e-grid.sf-grid .e-filterbarcell.e-frozen-left-border {
  border-left: 2px solid rgba(49, 122, 185, 0.6);
}
