...
import { PointF, Rectangle } from '@syncfusion/ej2-pdf-export/src/implementation/drawing/pdf-drawing';
import { PdfColorBlend } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/brushes/pdf-color-blend';
import { PdfBlend } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/brushes/pdf-blend';
import { PdfGradientBrush } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/brushes/pdf-gradient-brush';
import { PdfExtend, PdfLinearGradientMode } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/brushes/enum';
/**
