import { TtfReader } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/fonts/ttf-reader';
import { TtfMetrics } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/fonts/ttf-metrics';
