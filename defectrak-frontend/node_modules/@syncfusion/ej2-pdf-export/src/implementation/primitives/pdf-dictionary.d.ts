...
import { Dictionary } from '@syncfusion/ej2-pdf-export/src/implementation/collections/dictionary';
import { PdfName } from '@syncfusion/ej2-pdf-export/src/implementation/primitives/pdf-name';
import { ObjectStatus } from '@syncfusion/ej2-pdf-export/src/implementation/input-output/enum';
import { PdfCrossTable } from '@syncfusion/ej2-pdf-export/src/implementation/input-output/pdf-cross-table';
import { DictionaryProperties } from '@syncfusion/ej2-pdf-export/src/implementation/input-output/pdf-dictionary-properties';
import { PdfSectionCollection } from '@syncfusion/ej2-pdf-export/src/implementation/pages/pdf-section-collection';
import { PdfAnnotation } from '@syncfusion/ej2-pdf-export/src/implementation/annotations/annotation';
import { PdfSection, PageSettingsState } from '@syncfusion/ej2-pdf-export/src/implementation/pages/pdf-section';
import { PdfPage } from '@syncfusion/ej2-pdf-export/src/implementation/pages/pdf-page';
import { UnicodeTrueTypeFont } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/fonts/unicode-true-type-font';
/**
