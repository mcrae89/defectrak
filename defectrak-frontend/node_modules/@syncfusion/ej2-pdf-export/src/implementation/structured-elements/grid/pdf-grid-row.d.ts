...
import { PdfGridCellCollection } from '@syncfusion/ej2-pdf-export/src/implementation/structured-elements/grid/pdf-grid-cell';
import { PdfGridRowStyle } from '@syncfusion/ej2-pdf-export/src/implementation/structured-elements/grid/styles/style';
