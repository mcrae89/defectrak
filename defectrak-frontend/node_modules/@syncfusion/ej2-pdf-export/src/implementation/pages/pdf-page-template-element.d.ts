 ...
 */
import { PdfDockStyle, PdfAlignmentStyle, TemplateType } from '@syncfusion/ej2-pdf-export/src/implementation/pages/enum';
import { PointF, SizeF } from '@syncfusion/ej2-pdf-export/src/implementation/drawing/pdf-drawing';
