...
import { PdfWriter } from '@syncfusion/ej2-pdf-export/src/implementation/input-output/pdf-writer';
import { PdfDictionary } from '@syncfusion/ej2-pdf-export/src/implementation/primitives/pdf-dictionary';
import { PdfMainObjectCollection } from '@syncfusion/ej2-pdf-export/src/implementation/input-output/pdf-main-object-collection';
import { PdfReference } from '@syncfusion/ej2-pdf-export/src/implementation/primitives/pdf-reference';
import { ObjectType } from '@syncfusion/ej2-pdf-export/src/implementation/input-output/cross-table';
