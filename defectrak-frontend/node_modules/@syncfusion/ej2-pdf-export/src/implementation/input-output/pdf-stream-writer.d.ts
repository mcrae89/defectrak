...
import { PointF, RectangleF } from '@syncfusion/ej2-pdf-export/src/implementation/drawing/pdf-drawing';
import { TextRenderingMode, PdfLineCap, PdfLineJoin, PdfColorSpace } from '@syncfusion/ej2-pdf-export/src/implementation/graphics/enum';
import { PdfString } from '@syncfusion/ej2-pdf-export/src/implementation/primitives/pdf-string';
