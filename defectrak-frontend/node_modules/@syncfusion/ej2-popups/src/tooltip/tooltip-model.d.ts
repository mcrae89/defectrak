import { Component, Property, ChildProperty, Event, BaseEventArgs, append, compile } from '@syncfusion/ej2-base';import { EventHandler, EmitType, Touch, TapEventArgs, Browser, Animation as PopupAnimation, animationMode } from '@syncfusion/ej2-base';import { isNullOrUndefined, getUniqueID, formatUnit, select, selectAll } from '@syncfusion/ej2-base';import { attributes, closest, removeClass, addClass, remove } from '@syncfusion/ej2-base';import { NotifyPropertyChanges, INotifyPropertyChanged, Complex, SanitizeHtmlHelper } from '@syncfusion/ej2-base';import { Popup } from '@syncfusion/ej2-popups/src/popup/popup';import { OffsetPosition, calculatePosition } from '@syncfusion/ej2-popups/src/common/position';import { isCollide, fit, destroy as collisionDestroy } from '@syncfusion/ej2-popups/src/common/collision';
import {TooltipAnimationSettings,Position,TipPointerPosition,TooltipEventArgs} from "@syncfusion/ej2-popups/src/tooltip/tooltip";
