import { EventHandler, Internationalization, Property, NotifyPropertyChanges, Browser, RippleOptions } from '@syncfusion/ej2-base';import { Animation, EmitType, Event, AnimationModel, cldrData, getDefaultDateObject, detach } from '@syncfusion/ej2-base';import { createElement, remove, addClass, L10n, removeClass, closest, append, attributes } from '@syncfusion/ej2-base';import { KeyboardEvents, KeyboardEventArgs, isNullOrUndefined, formatUnit, getValue, rippleEffect } from '@syncfusion/ej2-base';import { ModuleDeclaration, extend, Touch, SwipeEventArgs } from '@syncfusion/ej2-base';import { Popup } from '@syncfusion/ej2-popups';import { Input } from '@syncfusion/ej2-inputs';import { BlurEventArgs, ClearedEventArgs, CalendarType, CalendarView, DayHeaderFormats } from '@syncfusion/ej2-calendars/src/calendar/calendar';import { DatePicker, PopupObjectArgs } from '@syncfusion/ej2-calendars/src/datepicker/datepicker';import { TimePickerBase } from '@syncfusion/ej2-calendars/src/timepicker/timepicker';import {MaskPlaceholderModel} from '@syncfusion/ej2-calendars/src/common/maskplaceholder-model';
import {DatePickerModel} from "@syncfusion/ej2-calendars/src/datepicker/datepicker-model";
