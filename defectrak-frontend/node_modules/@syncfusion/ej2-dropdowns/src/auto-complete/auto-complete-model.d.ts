import { Property, EventHandler, KeyboardEventArgs, isNullOrUndefined, detach, getValue } from '@syncfusion/ej2-base';import { Event, EmitType, Complex } from '@syncfusion/ej2-base';import { removeClass, NotifyPropertyChanges } from '@syncfusion/ej2-base';import { dropDownListClasses } from '@syncfusion/ej2-dropdowns/src/drop-down-list/drop-down-list';import { ComboBox } from '@syncfusion/ej2-dropdowns/src/combo-box/combo-box';import { highlightSearch, revertHighlightSearch } from '@syncfusion/ej2-dropdowns/src/common/highlight-search';import { Search } from '@syncfusion/ej2-dropdowns/src/common/incremental-search';import { FieldSettingsModel } from '@syncfusion/ej2-dropdowns/src/drop-down-base/drop-down-base-model';import { FieldSettings, FilteringEventArgs, FilterType, ResultData } from '@syncfusion/ej2-dropdowns/src/drop-down-base/drop-down-base';import { FloatLabelType, Input } from '@syncfusion/ej2-inputs';import { DataManager, Predicate, Query } from '@syncfusion/ej2-data';
import {ComboBoxModel} from "@syncfusion/ej2-dropdowns/src/combo-box/combo-box-model";
