...
import { VirtualInfo } from '@syncfusion/ej2-dropdowns/src/common/virtual-scroll';
import { DataManager, Query } from '@syncfusion/ej2-data';
import { FieldSettingsModel } from '@syncfusion/ej2-dropdowns/src/drop-down-base/drop-down-base-model';
import { GeneratedData } from '@syncfusion/ej2-dropdowns/src/drop-down-list/drop-down-list';
import { visualMode } from '@syncfusion/ej2-dropdowns/src/multi-select';
/**
