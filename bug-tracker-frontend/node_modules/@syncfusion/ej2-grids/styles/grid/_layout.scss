...
@include export-module('grid-layout') {
  ...
  #{&}.e-grid {
    ...
    .e-gridheader {
      & tr:first-child th:not(.e-freezeleftborder, .e-freezerightborder) {
        border-top: 0 none;
      }
    ...
    .e-gridheader .e-headercell .e-headercelldiv.e-headerchkcelldiv {
      @if $grid-skin == 'bootstrap5' or $grid-skin == 'bootstrap5.3' or $grid-skin == 'tailwind3' {
        padding-left: 8px;
      }
      @else if $grid-skin == 'fluent' {
        padding-left: 5px;
    ...
    .e-gridheader .e-headercell:not(:first-child) .e-headercelldiv.e-headerchkcelldiv {
      @if $grid-skin == 'tailwind3' {
        padding-left: 12px;
      }
    }
    ...
    &.e-rtl .e-gridheader .e-headercell:not(:first-child) .e-headercelldiv.e-headerchkcelldiv{
      @if $grid-skin == 'tailwind3' {
        padding-right: 11px;
      }
    }
    ...
    &.e-default .e-gridheader {
      th.e-firstcell,
      th.e-laststackcell:not(:has(.e-rhandler.e-rcursor)) {
        @include grid-border-width-styles;
      }
    }
    ...
    &.e-wrap {
      ...
      & .e-stackedheader .e-columnheader :not(.e-columnsheader) {
        .e-stackedheadercelldiv,
        .e-headercelldiv {
    ...
    &.e-wrap .e-columnheader {
      ...
      .e-sortfilterdiv .e-filtermenudiv  {
        line-height: $grid-wrap-line-height;
        margin: $grid-header-wrap-filtermenu-div-margin;
      }
    ...
    &.e-wrap.e-rtl .e-columnheader {
      .e-filtermenudiv,
      .e-sortfilterdiv .e-filtermenudiv  {
        margin: $grid-rtl-wrap-fltrdiv-margin;
      }
    }
