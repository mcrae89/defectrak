...
public class BugControllerTest {
    ...
    @WithAnonymousUser
    @Test
    public void testGetAllBugs_Unauthenticated() throws Exception {
        // Arrange: create sample bugs.
        UserRole userRole = createDummyRole(1L,"ADMIN");
        Status status = createDummyStatus(1L,"open");
        Priority priority = createDummyPriority(1L, "low", "Active");
    ...
    @WithAnonymousUser
    @Test
    public void testGetBugByID_Found_Unauthenticated() throws Exception {
        // Arrange: create sample bug.
        UserRole userRole = createDummyRole(1L,"ADMIN");
        Status status = createDummyStatus(1L,"open");
        Priority priority = createDummyPriority(1L, "low", "Active");
    ...
    @WithAnonymousUser
    @Test
    public void testGetBugsById_NotFound_Unauthenticated() throws Exception {
        // Arrange: Return an empty Optional for an unknown id.
        Mockito.when(bugRepository.findById(99L))
                .thenReturn(Optional.empty());
    ...
    @WithAnonymousUser
    @Test
    public void testCreateBugUsingBugDto_Unaunthenticated() throws Exception {
        UserRole userRole = createDummyRole(1L,"ADMIN");
        Status status = createDummyStatus(1L,"open");
        Priority priority = createDummyPriority(1L, "low", "Active");
        User assignee = createDummyUser(1L, "first@example.com", "First", "User", "password", userRole);
    ...
    @WithAnonymousUser
    @Test
    public void testUpdateBugUsingBugDto_Found_Unauthenticated() throws Exception {
        // Arrange: create dummy related entities using helper methods.
        UserRole userRole = createDummyRole(1L, "ADMIN");
        Status status = createDummyStatus(1L, "open");
        Priority priority = createDummyPriority(1L, "low", "Active");
    ...
    @WithAnonymousUser
    @Test
    public void testDeleteBug_Found_Unauthenticated() throws Exception {
        // Arrange: create sample bug.
        UserRole userRole = createDummyRole(1L,"ADMIN");
        Status status = createDummyStatus(1L,"open");
        Priority priority = createDummyPriority(1L, "low", "Active");
    ...
    @WithAnonymousUser
    @Test
    public void testDeleteBug_NotFound_Unauthenticated() throws Exception {
        // Arrange: For an unknown id, return an empty Optional.
        Mockito.when(bugRepository.findById(1L))
                .thenReturn(Optional.empty());
